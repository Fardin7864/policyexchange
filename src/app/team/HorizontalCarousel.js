...
const cards = [
  {
    ...
    details: {
      ...
      experience:
        "Dr. Reaz has extensive experience in policy research and development, with a focus on socioeconomic issues.",
      education:
        "Dr. Reaz holds a Ph.D. in Economics from a prestigious university.",
      interests: [
        "Policy Research",
  ...
  },
  {
    ...
    details: {
      ...
      experience:
        "Mr. Alam brings a wealth of experience in economic research, analysis, and management to our organization.",
      education:
        "Mr. Alam holds a Master's degree in Economics from a renowned institution.",
      interests: ["Economic Analysis", "Strategic Management", "Research"],
    },
  },
  {
    id: 7,
    ...
    details: {
      ...
      experience:
        "Rahmina has a background in social science research, with a focus on quantitative analysis.",
      education:
        "Rahmina holds a Bachelor's degree in Economics from a reputed university.",
      interests: ["Quantitative Analysis", "Policy Research", "Social Issues"],
    },
  },
  {
    id: 3,
    ...
    details: {
      ...
      experience:
        "Pinaky has a strong background in policy analysis and project coordination, with a focus on social and governance issues.",
      education:
        "Pinaky holds a Master's degree in Public Policy from a leading institution.",
      interests: ["Policy Analysis", "Project Management", "Governance Issues"],
    },
  },
  {
    id: 5,
    ...
    details: {
      ...
      experience:
        "Rafid has a keen interest in policy research and data management, contributing to various research projects.",
      education: "Rafid is pursuing a Bachelor's degree in Economics.",
      interests: ["Data Analysis", "Policy Research", "Economic Development"],
    },
  },
  {
    id: 6,
    ...
    details: {
      ...
      experience:
        "Lamia has experience in stakeholder management and communications, fostering relationships with diverse stakeholders.",
      education:
        "Lamia holds a Bachelor's degree in Communications from a reputable university.",
      interests: [
  ...
  },
  {
    ...
    details: {
      ...
      experience:
        "Hasnat has a wealth of experience in economic research and analysis, contributing valuable insights to inform policy decisions.",
      education:
        "Hasnat holds a Master's degree in Economics from a renowned university.",
      interests: [
        "Economic Analysis",
        "Policy Formulation",
  ...
  },
  {
    ...
    details: {
      ...
      experience:
        "Ms. Rahman has actively participated in various research projects, contributing to data collection, analysis, and report preparation.",
      education:
        "Ms. Rahman holds a Bachelor's degree in Economics, specializing in research methodologies.",
      interests: [
        "Data Analysis",
  ...
  },
  {
    ...
    details: {
      ...
      experience:
        "Ms. Nawrin has experience in conducting research projects, analyzing data, and providing insights to inform decision-making processes.",
      education:
        "Ms. Nawrin holds a Bachelor's degree in Economics with a focus on research methodology.",
      interests: ["Research Methodology", "Data Analysis", "Decision Support"],
    },
  },
  {
    id: 4,
    ...
    details: {
      ...
      experience:
        "Naziba has a background in social science research, with a focus on qualitative research methodologies.",
      education:
        "Naziba holds a Bachelor's degree in Sociology from a reputed university.",
      interests: ["Policy Research", "Qualitative Analysis", "Social Issues"],
    },
  },
  {
    id: 10,
    ...
    details: {
      ...
      experience:
        "Mr. Tanmoy has gained valuable experience in conducting literature reviews, gathering data, and assisting in research analysis.",
      education:
        "Mr. Tanmoy holds a Bachelor's degree in Economics with a focus on research methodologies.",
      interests: [
        "Research Methodologies",
        "Data Collection",
        "Literature Review",
  ...
  },
  {
    ...
    details: {
      ...
      experience:
        "Mr. Alam has a proven track record of efficiently managing office operations, scheduling appointments, and providing administrative support.",
      education:
        "Mr. Alam holds a Bachelor's degree in Business Administration with a focus on office management.",
      interests: [
        "Office Management",
