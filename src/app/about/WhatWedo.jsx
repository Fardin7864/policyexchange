  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-8 mt-5 ">
        ...
        <WhatWeDoCard
          icon={<FaCrown className="text-5xl text-center text-white" />}
        ...
        />
        <WhatWeDoCard
          icon={<FaDisplay className="text-5xl text-center text-white" />}
          title="Dialogues"
        ...
        />
        <WhatWeDoCard
          icon={<BsBank2 className="text-5xl text-center text-white" />}
