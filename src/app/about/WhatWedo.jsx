  ...
  return (
    ...
    >
      <div className="col-span-3">
        <h1 className=" text-5xl font-extrabold mb-10">WHAT WE DO</h1>
      </div>

      <div className=" col-span-5">
        <WhatWeDoCard
          icon={<img src="/about/5.png" className="h-12 w-12" alt="" />}
        ...
        />
        <WhatWeDoCard
          icon={<img src="/about/6.png" className="h-12 w-12" alt="" />}
        ...
        />
        <WhatWeDoCard
          icon={<img src="/about/7.png" className="h-12 w-12" alt="" />}
        ...
        />
        <WhatWeDoCard
          icon={<img src="/about/8.png" className="h-12 w-12" alt="" />}
